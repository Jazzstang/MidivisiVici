 ...
 *  - Un composant dynamique pour les différents modes de transformation
 */
class TransformBase : public juce::Component
{
public:
    explicit TransformBase(juce::AudioProcessorValueTreeState& state);
...
private:
    ...
    // === Header ===
    juce::ToggleButton headerButton { "Transform" };
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(TransformBase)
};
